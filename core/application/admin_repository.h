...
public:
  ...
  virtual std::optional<AdminAccount>
  findAdminByUsername(std::string_view username) = 0;
  ...
  virtual AccountWriteResult updateManagedUserStatus(
  ...
  virtual bool createStationWithChargers(Station &station,
                                         const InitialChargerSpec &spec) = 0;
  ...
  virtual bool tariffOverlaps(const std::string &adcode, std::int64_t from,
                              std::int64_t to) = 0;
  ...
  virtual std::optional<DeviceCommand>
  deviceCommand(const std::string &commandNo) = 0;
  ...
  virtual std::optional<BackupRecord>
  backup(const std::string &backupNo) = 0;
